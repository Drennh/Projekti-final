...
<body>
    ...
    <div class="boxes">
        ...
        <div class="left">
            ...
            <p class="creative">Lorem ipsum dolor sit amet sit <br> ipsum dolor sit amet dolor consectetur.</p>
        </div>
        ...
        <div class="div2"id="col">
           <img id="icons" src="../icons/check.png" alt=""> <br>
            <h3 id="txt">Checkup</h3>
            <p id="txt" class="ptext" >Lorem ipsum dolor sit amet consectetur adipisicing elit. Provident.</p>
        </div>
